...
func ConfigSliceDecoder(name types.CheckerSchedulerType, args []string) ConfigDecoder {
...
func CreateScheduler(typ types.CheckerSchedulerType, oc *operator.Controller, storage endpoint.ConfigStorage, dec ConfigDecoder, removeSchedulerCb ...func(string) error) (Scheduler, error) {
